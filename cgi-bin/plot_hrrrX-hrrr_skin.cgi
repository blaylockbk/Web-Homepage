...
temp = grbs.select(name="Temperature")[-1].values[subset[domain][0]:subset[domain][1],subset[domain][2]:subset[domain][3]] - 273.15
lat, lon = grbs.select(name="Temperature")[-1].latlons()
...
tempX = grbsX.select(name="Temperature")[-1].values[subset[domain][0]:subset[domain][1],subset[domain][2]:subset[domain][3]] - 273.15
...
plt.suptitle(yesterday+" h"+hour+'z   Skin Temperature    PlotTimer:'+str(timer) )
