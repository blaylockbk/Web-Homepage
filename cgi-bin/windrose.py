...
class WindroseAxes(PolarAxes):
    ...
    def cla(self):
        ...
        self.set_thetagrids(angles=self.theta_angles, labels=self.theta_labels, fontsize = 20) # Changed Font Size for Wind Directoin
    ...
    def legend(self, loc='lower left', **kwargs):
        ...
        def get_labels():
            ...
            labels = ["[%.1f : %0.1f] ppb" %(labels[i], labels[i+1]) \
    ...
    def _init_plot(self, dir, var, **kwargs):
        ...
        if bins is None:
            bins = np.linspace(0, 10, 6)                                        # set the range of color scale
