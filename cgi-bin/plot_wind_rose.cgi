...
#       Septem 26, 2015: just plot wind rose
#
...
rose_type = form['rose_type'].value # only wspd or spd_clock in this version

time_option = form['time_option'].value

plot_max = int(form['plot_max'].value)

hour_interval = form['HI'].value

threshold = form['threshold'].value

# Default plot max to 5% if the user is looking at an 'clock' plot for 'All Day'
...
#reassign wind_dir, wind_spd with the indexes
...
## Plot wind speed clock
##-----------------------------------------
if rose_type =="spd_clock":
    #Instead of a wind direction
