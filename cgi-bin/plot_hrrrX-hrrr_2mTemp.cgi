...
tempX = grbsX.select(name="2 metre temperature")[0].values[subset[domain][0]:subset[domain][1],subset[domain][2]:subset[domain][3]] - 273.15
...
plt.suptitle(yesterday+" h"+hour+'z   2-m Temperature')
