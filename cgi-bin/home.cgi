...
<meta http-equiv="refresh" content="300; url=/gslso3s/cgi-bin/home.cgi?tz='''+mytzone+'''&region='''+myregion+'''" />
</head>
<body>
<script src="/gslso3s/js/site/sitemenu.js"></script>
<br>
<img style="vertical-align:middle" src="/gslso3s/images/SO3S_Small_Logo.png" width="150"><span style="padding-left:20px"><b><font COLOR="#0000DD" SIZE=+3>Summer 2015 Ozone Study (SO<sub>3</sub>S)</font></b>
<br>
<div style="width:900px"><br>
Welcome to the home page of the Great Salt Lake Summer Ozone Study.  This page provides access to some of the air quality and meteorological observations collected in real time as part of this project, which takes place during the summer of 2015.
<br><br>
While the experiment is in progress, this page will show data collected within the previous '''+str(minback)+''' minutes from several different platforms.
<br><br>
...
if(mytzone == 'utc'):
	print'''<input type="button" onClick="parent.location='/gslso3s/cgi-bin/home.cgi?tz=local&region='''+myregion+''''" value="Change to Local Time">'''
else:
	print'''<input type="button" onClick="parent.location='/gslso3s/cgi-bin/home.cgi?tz=utc&region='''+myregion+''''" value="Change to UTC Time">'''
print'''
<input type="button" onClick="parent.location='/gslso3s/cgi-bin/home.cgi?tz='''+mytzone+'''&region=GSL'" value="View Great Salt Lake">
<input type="button" onClick="parent.location='/gslso3s/cgi-bin/home.cgi?tz='''+mytzone+'''&region=SYR'" value="View Antelope Island">
<input type="button" onClick="parent.location='/gslso3s/cgi-bin/home.cgi?tz='''+mytzone+'''&region=SLC'" value="View Salt Lake and Tooele Valleys">
<br><br>
...
<br><br>
The table below provides the most recent '''+str(varoptions[varchoice].lower())+''' observation collected from each platform available on the map, with links to time series graphs available as well to show data over the previous 24 hours.  Rows can be sorted by clicking on the table headers.
<br>
<script>'''
...
print'''	var topinfo2 = L.control();
	...
	topinfo2.update = function (props) {
		this._div.innerHTML = '<input type="button" onClick="parent.location=&apos;/gslso3s/cgi-bin/home_fullscreen.cgi?tz='''+mytzone+'''&region='''+myregion+'''&apos;" value="Full Screen Version">';
	};
	topinfo2.addTo(map);'''
...
if(mytzone == 'local'):
	print'''<b><font SIZE=+1 color="#0000CC">Currently '''+currtimestring+''' ('''+currtimestringutc+''')</font></b><br>'''
else:
	print'''<b><font SIZE=+1 color="#0000CC">Currently '''+currtimestring+'''</font></b><br>'''
...
for stid in sorted(mobilestidlist):
	try:
		...
		skip = 1
		# print'''<tr><td class="table1"><font><b>Mobile</b></font></td><td class="table1"><font><b>'''+stid+'''</b></font></td><td class="table1" colspan="3"><b><font>No real-time data within '''+str(minback)+''' minutes</font></b></td></tr>'''
